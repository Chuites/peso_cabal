...
<div class="row">
        <div class="col-md-6" >
                ...
                <?php echo Form::date('fecha_solicitud', '', array_merge(['class' => 'form-control', 'id' => 'fecha_solicitud'])); ?>
...
<div class="row">
        <div class="col-md-12" >
                <?php echo Form::label('Escribano o Camara de Gobierno', 'Escribano o Camara de Gobierno', ['class' => 'control-label requerido', 'id' => 'lb_escribano']); ?>

                <?php echo Form::text('escribana_camara', '', array_merge(['class' => 'form-control', 'id' => 'escribana_camara'])); ?>

        </div>
</div>
<div class="row">
        <div class="col-md-12" >
                <?php echo Form::label('Objeto del contrato', 'Objeto del contrato', ['class' => 'control-label requerido', 'id' => 'lb_objeto_contrato']); ?>

                <?php echo Form::textarea('objeto_contrato', '', array_merge(['class' => 'form-control', 'id' => 'objeto_contrato', 'rows'=>'3'])); ?>

        </div>
</div>

<?php echo Form::label('Seleccione los documentos a solictar:', 'Seleccione los documentos a solictar:', ['class' => 'control-label ', 'id' => 'lb_objeto_contrato']); ?>

<div class="row">
    
    <div class="col-md-6" >
            <?php echo Form::label('Copia simple', 'Copia simple', ['class' => 'control-label ', 'id' => 'lb_objeto_contrato']); ?>

            <?php echo e(Form::checkbox(null,null,null, array('onClick'=>"Select_Cod(this,'1','new_cadena');"))); ?>

    </div>
    <div class="col-md-6" >
            <?php echo Form::label('Copia simple legalizada', 'Copia simple legalizada', ['class' => 'control-label']); ?>

            <?php echo e(Form::checkbox(null,null,null, array('onClick'=>"Select_Cod(this,'2','new_cadena');"))); ?>

    </div>
</div>
<div class="row">
    <div class="col-md-6" >
            <?php echo Form::label('Testimonio', 'Testimonio', ['class' => 'control-label ', 'id' => 'lb_objeto_contrato']); ?>

            <?php echo e(Form::checkbox(null,null,null, array('onClick'=>"Select_Cod(this,'3','new_cadena');"))); ?>

    </div>
    <div class="col-md-6" >
            <?php echo Form::label('Testimonio con duplicado', 'Testimonio con duplicado', ['class' => 'control-label ', 'id' => 'lb_objeto_contrato']); ?>

            <?php echo e(Form::checkbox(null,null,null, array('onClick'=>"Select_Cod(this,'4','new_cadena');"))); ?>
