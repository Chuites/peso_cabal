...
/*
 * componente para crear un text area basado en bootstrap
 * verifica si son envidados los parametros de lo contrario usa valores default
 * @autor Marco Prado
 */

$name = (isset($name) && $name)? $name : 'textarea';
...
<div class="form-group" id="inputDiv_{{$name}}">
    ...
    {!! Form::textarea($name, $value, array_merge(['class' => $class, 'id' => $name], $attributes)) !!}
